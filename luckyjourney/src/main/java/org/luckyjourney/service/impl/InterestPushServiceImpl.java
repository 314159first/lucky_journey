...
public class InterestPushServiceImpl implements InterestPushService {
    ...
    public void initUserModel(Long userId, List<String> labels) {
        ...
        userDataPersistenceService.replaceUserInterestModel(userId, modelMap);
        // 为用户模型设置ttl
    ...
    public void updateUserModel(UserModel userModel) {
        ...
        if (userId != null) {
            ...
            // 更新用户模型
            redisCacheUtil.hmset(key, modelMap);
            userDataPersistenceService.saveUserInterestModel(userId, modelMap, models);
        }
    ...
    public Collection<Long> listVideoIdByUserModel(User user) {
        ...
        if (user != null) {
            ...
            if (ObjectUtils.isEmpty(modelMap)) {
                modelMap = userDataPersistenceService.restoreUserInterestModelToRedis(userId);
            }
            if (!ObjectUtils.isEmpty(modelMap)) {
                // 组成数组
