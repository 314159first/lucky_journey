...
import org.luckyjourney.entity.vo.SearchResultVO;
...
public class IndexController {
    ...
    public R searchAll(@RequestParam(required = false) String searchName, BasePage basePage,HttpServletRequest request){
        SearchResultVO result = new SearchResultVO();
        result.setVideos(videoService.searchVideo(searchName,basePage,JwtUtils.getUserId(request)));
        result.setUsers(searchService.searchUsers(searchName,basePage));
